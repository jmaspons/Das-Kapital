...
Model que representa els processos descrits a «El capital. Crítica de l'economia política» (Karl Marx 1867, 1885, 1894).
...
El capital augmenta i es desenvolupa. Quan els nous sistemes de producció augmenten la productivitat, baixa el valor de canvi de les mercaderies. Els modes de producció menys eficients no poden produir a un cost per sota del valor de canvi i s'abandonen (cel·les en vermell). En el moment que la producció total supera la demanda, les empreses menys productives es descapitalitzen i no tenen capital per contractar treballadors fent que s'aturi la producció. La simulació sol estabilitzar-se en un monopoli d'una o varies empresa al nivell de màxim de productivitat, en funció de la demanda de mercaderies.
...
Afegir diferents tipus de mercaderies, cadenes de producció de mercaderies, sindicats, impostos, recursos naturals finits que condicionen el valor de mercat del capital constant, demanda de mercaderies en funció de la població total, sistema financer, comerç internacional, imperialisme...
